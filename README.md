...
Installation:
 - Connect the servo motor to the 3-pin connector, with the brown wire closer to the power connector. Please check image of the assembled device, in this repository.
